"""
    账单报表：平台费
    db_sett_oversea.t_channel_month_plt_bill
"""
...
class PltBillReportData(BaseBean):
    def __init__(self):
        self.Fsett_month = ''
        self.Fbill_month = ''
        self.Fdue_month = ''
    ...
    def update_merchant_base_bill(self, base_bill: MerchantBillBaseData):
        ...
        self.Fmdm_id = base_bill.merchant_mdm_id
        self.Fmdm_name = base_bill.merchant_mdm_name
        ...
        self.Fori_settlement = base_bill.ori_plt_fee
        ...
        self.Fsett_settlement = base_bill.sett_plt_fee
        ...
        self.Frmb_settlement = base_bill.rmb_plt_fee
    ...
    def cal_plt_diff_channel(self, base_bill: ChannelBillBaseData):
        spoa_pay = SpoaInfoData.get_spoa_pay()
        ori_channel_settlement = base_bill.ori_income - base_bill.ori_refund - \
                                 base_bill.ori_channel_tax - base_bill.ori_channel_fee
        sett_channel_settlement = base_bill.sett_income - base_bill.sett_refund - \
                                  base_bill.sett_channel_tax - base_bill.sett_channel_fee
        rmb_channel_settlement = base_bill.rmb_income - base_bill.rmb_refund - \
                                 base_bill.rmb_channel_tax - base_bill.rmb_channel_fee
        ...
        self.Fsett_type = ''
        self.Fbilling_type = "MidasPay"
        self.Fplt_fee_type = "CHANNEL_DIFF"
        self.Fmdm_id = base_bill.merchant_mdm_id
        self.Fmdm_name = base_bill.merchant_mdm_name
        self.Fchannel_mdm_id = base_bill.channel_mdm_id
        self.Fchannel_mdm_name = base_bill.channel_mdm_name
        ...
        self.Fori_refund = base_bill.ori_refund
        self.Fori_plt_amount = base_bill.ori_plt_fee
        self.Fori_settlement = ori_channel_settlement
        self.Fori_sett_currency_rate = base_bill.ori_sett_currency_rate
        ...
        self.Fsett_refund = base_bill.sett_refund
        self.Fsett_plt_amount = base_bill.sett_plt_fee
        self.Fsett_settlement = sett_channel_settlement
        self.Fsett_rmb_currency_rate = base_bill.sett_rmb_currency_rate

        self.Frmb_income = base_bill.rmb_income
        self.Frmb_refund = base_bill.rmb_refund
        self.Frmb_plt_amount = base_bill.rmb_plt_fee
        self.Frmb_settlement = rmb_channel_settlement
        self.Fims_channel_id = '1075'
        self.Fims_channel_name = '技术服务(midaspay)'
        self.Fchannel_contract_no = base_bill.channel_contract_no
        self.Fmerchant_contract_no = base_bill.merchant_contract_no

    def cal_plt_diff_merchant(self, base_bill: MerchantBillBaseData):
        spoa_pay = SpoaInfoData.get_spoa_pay()
        ori_channel_settlement = base_bill.ori_income - base_bill.ori_refund - \
                                 base_bill.ori_channel_tax - base_bill.ori_channel_fee
        sett_channel_settlement = base_bill.sett_income - base_bill.sett_refund - \
    ...
    def batch_insert(db_sett: MySQLClient, sett_month, plt_fee_type, data_list):
        sql = '''
            delete from db_sett_oversea.t_channel_month_plt_bill 
            where Fsett_month = '{}' and Fplt_fee_type = '{}'
        '''.format(sett_month, plt_fee_type)
        db_sett.update(sql)
        db_sett.batch_insert(data_list, "db_sett_oversea", "t_channel_month_plt_bill")

    @staticmethod
    def get_bill_list(db_sett: MySQLClient, sett_month):
        sql = '''
            select * from db_sett_oversea.t_channel_month_plt_bill where Fsett_month = '{}'
        '''.format(sett_month)
        db_ret = db_sett.query(sql, cls=PltBillReportData)
        data_list: List[PltBillReportData] = db_ret.data
        return data_list
